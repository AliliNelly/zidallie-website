  ...
  return (
    <section
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <ul
          role="list"
          className="mx-auto mt-16 grid max-w-2xl  grid-cols-1 gap-10 sm:gap-8 lg:mt-20 lg:max-w-none lg:grid-cols-3">
          {testimonials.map((item, index) => (
            <li key={index}>
              <ul role="list" className="flex flex-col gap-y-10 sm:gap-y-8 ">
                <li>
                  <figure className="relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10 h-[260px]">
                    <svg
                      aria-hidden="true"
                      width={105}
                      height={78}
                    ...
                    <blockquote className="relative">
                      <h2 className="font-bold mb-3">{item.heading}</h2>
